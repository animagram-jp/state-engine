// WASI binding for state-engine.
//
// Backend-oriented: reads manifest YAML files via std::fs.
// In a WASI environment the host mounts the manifest directory,
// and std::fs maps to WASI fd/path APIs transparently.
//
// TODO: add wasmer/wasmtime host-side mounting docs.
// TODO: expose Manifest/State via WASI-compatible FFI (e.g. C ABI exports).
